...
LDFLAGS+=-L. -g
#^|
EXAMPLESOBJS=  motor.o register.o sensor.o uc.o queue.o main.o generat.o cpu.o transduc.o distri.o com.o linpack.o debug.o trafico.o
#
...
#^|
motor.o: /cygdrive/C/Eclipse/workspace/Puertas/motor.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
register.o: /cygdrive/C/Eclipse/workspace/Puertas/register.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
sensor.o: /cygdrive/C/Eclipse/workspace/Puertas/sensor.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
uc.o: /cygdrive/C/Eclipse/workspace/Puertas/uc.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
#
...
#^|
motor.o: /cygdrive/C/Eclipse/workspace/Puertas/motor.cpp \
 /cygdrive/C/Eclipse/workspace/Puertas/motor.h \
...
register.o: /cygdrive/C/Eclipse/workspace/Puertas/register.cpp \
 ...
 /cygdrive/C/Eclipse/workspace/Puertas/sensor.h \
 /cygdrive/C/Eclipse/workspace/Puertas/uc.h \
 /cygdrive/C/Eclipse/workspace/Puertas/motor.h
sensor.o: /cygdrive/C/Eclipse/workspace/Puertas/sensor.cpp \
 /cygdrive/C/Eclipse/workspace/Puertas/sensor.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/atomic.h \
